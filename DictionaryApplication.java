...
public class DictionaryApplication extends DictionaryManagement {
    ...
    private final Document doc = resultTextPane.getStyledDocument();
    ...
    private final JMenuItem openApi = new JMenuItem("OpenApi",openGoogleApi);
            ...
            public void actionPerformed(ActionEvent e) {
               if (translator.checkInternet()) {
                   try {
                       ...
                       translateAPI.setText("Word not found!!1");
    ...
    private void prepareGUI() throws Exception{
        ...
        targetLabel.setFont(new Font("Verdana",Font.CENTER_BASELINE,14));
